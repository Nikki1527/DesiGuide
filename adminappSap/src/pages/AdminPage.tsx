...
import { AddEditDestinationModal } from '../pages/admin/AddEditDestinationModal';
import { useDestinationPlaces } from '../hooks/useDestinationPlaces';
import { AddEditDestinationPlaceModal } from '../pages/admin/AddEditDestinationPlaceModal';
import GuideTrackingPage from '../pages/admin/GuideTrackingPage';
import { AddEditPackageModal } from '../pages/admin/AddEditPackageModal';
import { AddEditGuideModal } from '../pages/admin/AddEditGuideModal';
import SapUsersPage from './SapUsersPage';
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-4">
      ...
      <nav className="space-y-1">
        ...
        <Link 
          to="/admin/guide-tracking"
          className={`flex items-center px-4 py-3 rounded-lg text-sm font-medium ${
            isActive('/admin/guide-tracking') 
              ? 'bg-cyan-50 text-cyan-700' 
              : 'text-gray-700 hover:bg-gray-100'
          }`}
        >
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-grow">
            <Routes>
              ...
              <Route path="sap-users" element={<SapUsersPage />} />
              <Route path="guide-tracking" element={<GuideTrackingPage />} />
            </Routes>
          </div>
        </div>
      </div>
